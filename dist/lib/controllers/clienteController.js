...
const createCliente = async (req, res) => {
  ...
  try {
    ...
    await t.commit(); // Devolver cliente con contactos
...
const createClienteWithContacto = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({
      message: "Error al crear el cliente con contacto",
    });
  }
};
...
const deleteCliente = async (req, res) => {
  ...
  try {
    const idCliente = req.params.id; // Eliminar contactos primero
...
const updateCliente = async (req, res) => {
  ...
  try {
    ...
    await t.commit(); // Devolver cliente actualizado con contactos
