...
const contactoMiddleware = require("../middlewares/contactoMiddleware"); //Trae todos los contactos


route.get("/contacto", contactoController.getContacto); //Trae contacto por ID
