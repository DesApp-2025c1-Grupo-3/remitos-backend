...
const remitoSchema = Joi.object().keys({
  ...
  clienteId: Joi.number().integer().required().messages({
    "any.required": "Cliente es obligatorio",
  ...
  destinoId: Joi.number().integer().required().messages({
    "any.required": "Destino es obligatorio",
    "number.base": "Destino debe ser un número entero",
    "number.integer": "Destino debe ser un número entero",
  }),
  mercaderiaId: Joi.number().integer().required().messages({
    "any.required": "Mercadería es obligatoria",
    "number.base": "Mercadería debe ser un número entero",
    "number.integer": "Mercadería debe ser un número entero",
  }),
});
