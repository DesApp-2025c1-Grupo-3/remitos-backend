...
const remitoUpdateSchema = require("../schemas/remitoUpdateSchema");
const mercaderiaUpdateSchema = require("../schemas/mercaderiaUpdateSchema");
...
route.put(
  "/remito/:id",
  schemaValidator(remitoUpdateSchema),
...
//Edita mercadería de un remito
route.put(
  "/remito/:id/mercaderia",
  remitoMiddleware.validateId(Remito),
  schemaValidator(mercaderiaUpdateSchema),
  remitoController.updateMercaderia
);
