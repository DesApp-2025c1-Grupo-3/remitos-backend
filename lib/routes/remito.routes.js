...
const remitosByIdsSchema = require("../schemas/remitosByIdsSchema");
...
// Trae múltiples remitos por lista de IDs
route.post(
  "/remitos/by-id",
  schemaValidator(remitosByIdsSchema),
  remitoController.getRemitosByIds
);
//Trae remito por id
route.get(
  "/remito/:id",
...
//Iniciar reentrega de remito
route.post("/remito/:id/iniciar-reentrega",
  remitoMiddleware.validateRemitoId,
  remitoController.iniciarReentrega);
