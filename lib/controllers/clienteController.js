...
const { Cliente, Contacto, TipoEmpresa, sequelize } = require("../models");
...
const getCliente = async (req, res) => {
  try {
    ...
    // Paso 2: obtener los clientes completos con contactos y tipo de empresa
...
const createCliente = async (req, res) => {
  ...
  try {
    ...
    // Devolver cliente con contactos y tipo de empresa
    ...
    const cliente = await Cliente.create(
      {
        ...
        cuit_rut,
        direccion,
        tipoEmpresaId: tipoEmpresa, // Ahora es el ID del tipo de empresa
      },
      { transaction: t }
    );
...
const updateCliente = async (req, res) => {
  ...
  try {
    ...
    // Devolver cliente actualizado con contactos y tipo de empresa
